...
This shows that $f_4$ is at the same time the covariance of allele frequency differences (line 1), a sum of $f_2$ statistics (line 4), and a sum of allele frequency products (line 2).
