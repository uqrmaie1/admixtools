...
Here, `graph1` is a specific graph included in this R package, but you can provide any other graph in one of three formats.
...
If `outdir` is not specified, the f2 data is returned rather than written to disk. 
...
print(load(paste0(my_f2_dir, 'block_lengths.RData'))) # This loads block_lengths
```
