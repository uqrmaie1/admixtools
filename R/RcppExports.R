...
admixtools_omp_atfork_active_ <- function() {
    .Call('_admixtools_admixtools_omp_atfork_active_', PACKAGE = 'admixtools')
}

cpp_aftable_to_dstatnum <- function(aftable, p1, p2, p3, p4, modelvec, usesnps, allsnps, poly_only, nthreads = 1L, validate = TRUE) {
    .Call('_admixtools_cpp_aftable_to_dstatnum', PACKAGE = 'admixtools', aftable, p1, p2, p3, p4, modelvec, usesnps, allsnps, poly_only, nthreads, validate)
}

cpp_aftable_to_dstatnum_rowmeans <- function(aftable, p1, p2, p3, p4, modelvec, usesnps, allsnps, poly_only, nthreads = 1L, validate = TRUE) {
    .Call('_admixtools_cpp_aftable_to_dstatnum_rowmeans', PACKAGE = 'admixtools', aftable, p1, p2, p3, p4, modelvec, usesnps, allsnps, poly_only, nthreads, validate)
}

cpp_aftable_to_dstatden <- function(aftable, p1, p2, p3, p4, modelvec, usesnps, allsnps, poly_only, nthreads = 1L, validate = TRUE) {
    .Call('_admixtools_cpp_aftable_to_dstatden', PACKAGE = 'admixtools', aftable, p1, p2, p3, p4, modelvec, usesnps, allsnps, poly_only, nthreads, validate)
}
