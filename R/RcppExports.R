...
cpp_read_plink_afs <- function(bedfile, indvec, indvec2, ignore_pleuidy, verbose) {
    .Call('_admixtools_cpp_read_plink_afs', PACKAGE = 'admixtools', bedfile, indvec, indvec2, ignore_pleuidy, verbose)
}
