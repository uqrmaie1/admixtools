...
#' @export
#' @param afdat A list with three items with the same SNP in each row (generated by \code{\link{packedancestrymap_to_aftable}} or \code{\link{plink_to_aftable}})
#' \itemize{
...
#' @return `NULL` if `outdir` is specified. Otherwise, it should return a list with f2 data arrays
#' @examples
#' \dontrun{
...
afs_to_f2_blocks = function(afdat, maxmem = 8000, dist = 0.05, poly_only = TRUE,
  ...
  # continue here: do the right thing when returning f2arrs
