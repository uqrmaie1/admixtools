...
#' Data frame with fitted admixture graphs
#'
#' @format A data frame with fitted admixture graphs, generated by `find_graphs`
"example_winners"

#' Data frame with one fitted admixture graph
#'
#' @format A data frame with a fitted admixture graph, generated by `find_graphs`
"example_winner"
