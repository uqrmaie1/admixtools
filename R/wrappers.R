...
#' Parse qpGraph fstats output file
#'
#' Parses the fstats output file written by the original qpGraph program.
#' @param outfile Path to the qpGraph fstats output file.
#' @param denom1 Scaling denominator for f3-statistics.
#' @param denom2 Scaling denominator for f4-statistics.
#' @return A list of tibbles with parsed f-statistics.
#' @export
...
#' @param logfile Log file for reading score and outliers; defaults to `outfile`.
...
#' @export
#' @param parfile Output file generated by qpF4ratio
...
#' @param ... Arguments passed to \code{\link{msprime_sim}}.
#' @param blgsize SNP block size in Morgan for computing f2-statistics (default 0.05).
#' @param cleanup Delete temporary simulation files after reading (default `TRUE`).
#' @param verbose Print progress updates.
