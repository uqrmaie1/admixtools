...
Running `devtools::install_github("uqrmaie1/admixtools")` will compile C++ from the source code (this isn't necessary when installing packages from CRAN with `install.packages()`).

If you get the following error:

> Error: Failed to install 'admixtools' from GitHub:  Could not find tools necessary to compile a package.

you might be able to solve the problem by installing [Rtools](https://cran.r-project.org/bin/windows/Rtools/) for your version of R if you use Windows, or [Xcode Command Line Tools](https://developer.apple.com/download/more/) if you use macOS.
